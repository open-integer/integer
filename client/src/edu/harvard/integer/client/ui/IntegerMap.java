...
public class IntegerMap extends Layer {
	...
	public static final int MAX_MAP_HEIGHT = 1500;
	...
	protected void init_layout(int total) {
		...
		if (layout_type == ELLIPSE_LAYOUT ||
			...
			if (layout_position == LAYOUT_LEFT)
				original_x = width / 4;
			else if (layout_position == LAYOUT_RIGHT)
				original_x = width * 3/4;
			
			a = (MAP_WIDTH - icon_width * 2 - OFFSET_X) / 2;
			b = (MAP_HEIGHT - icon_height * 2 - OFFSET_Y) / 2;
			aa = a * a;
			ab = a * b;
			bb = b * b;
		}
