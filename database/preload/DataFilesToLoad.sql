...
VALUES
 	...
 	('edu.harvard.integer.common.persistence.DataPreLoadFile', 'SNMPv2-TC', 'SNMPv2-TC', 'MIB', NULL, NULL, NULL),
 	('edu.harvard.integer.common.persistence.DataPreLoadFile', 'SNMPv2-CONF', 'SNMPv2-CONF', 'MIB', NULL, NULL, NULL),
    ...
    ('edu.harvard.integer.common.persistence.DataPreLoadFile', 'SNMP-FRAMEWORK-MIB.my', 'SNMP-FRAMEWORK-MIB.my', 'MIB', NULL, NULL, NULL),
 	...
 	('edu.harvard.integer.common.persistence.DataPreLoadFile', 'CISCO-PRODUCTS-MIB.my', 'CISCO-PRODUCTS-MIB.my', 'MIB', NULL, NULL, NULL),
