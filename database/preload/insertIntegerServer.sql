...
VALUES
        (1, 'edu.harvard.integer.common.distribution.IntegerServer', NULL, NULL, 80, '54.236.100.155', 1),
	(2, 'edu.harvard.integer.common.distribution.IntegerServer', NULL, NULL, 80, '54.85.138.98', 2);
