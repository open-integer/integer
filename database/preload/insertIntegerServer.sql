...
VALUES
        (1, 'edu.harvard.integer.common.distribution.IntegerServer', NULL, NULL, 80, 'core_ip_address', 1),
	(2, 'edu.harvard.integer.common.distribution.IntegerServer', NULL, NULL, 80, 'front_end_ip_address', 2);
